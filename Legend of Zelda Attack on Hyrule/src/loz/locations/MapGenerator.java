...
public class MapGenerator{
    ...
    public static Location[][] getForest(){
        ...
        area[5][8] = new Location(EnumLocation.WALL_FOREST);
        
        area[6][0] =new Location(EnumLocation.WALL_FOREST);
        
        area[6][1] = new Location(EnumLocation.WALL_FOREST);
        
        area[6][8] = new Location(EnumLocation.WALL_FOREST);
        
        area[7][3] = new Location(EnumLocation.WALL_FOREST);
        
        area[7][8] = new Location(EnumLocation.WALL_FOREST);
        ...
        area[8][4] = new Location(EnumLocation.WALL_FOREST);
        
        area[8][5] = new Location(EnumLocation.WALL_FOREST);
        
        area[8][6] = new Location(EnumLocation.WALL_FOREST);
        
        area[8][8] = new Location(EnumLocation.WALL_FOREST);
        
        area[4][0] = new Location(EnumLocation.SPECIAL_FOREST);
    ...
    public static Location[][] getMountain(){
        ...
        area[3][3] = new Location(EnumLocation.SPECIAL_MOUNTAIN);
    ...
    public static Location[][] getLake(){
        ...
        area[0][2] = new Location(EnumLocation.SPECIAL_LAKE);
    ...
    public static Location[][] getCastle(){
        ...
        area[8][8] = new Location(EnumLocation.SPECIAL_CASTLE);
