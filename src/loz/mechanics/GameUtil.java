...
public class GameUtil {
	 ...
	 * @param text Text you want printed
	 */
	...
	public static void newSave(String name, int saveID){
		try{
			...
			file.write("Legend of Zelda: Attack on Hyrule Game Save File" + GameUtil.fileNewLine + 
	...
	public static void saveGame(Player player){
		try{
			...
			BufferedWriter file = new BufferedWriter(new FileWriter(newSave), 32768);
			file.write("Legend of Zelda: Attack on Hyrule Game Save File" + GameUtil.fileNewLine + 
						player.getName() + GameUtil.fileNewLine + 
						player.getHealth() + GameUtil.fileNewLine + 
						player.getTotalHealth() + GameUtil.fileNewLine + 
